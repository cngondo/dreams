...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { email: @sponsor.email, fname: @sponsor.fname, lname: @sponsor.lname, number: @sponsor.number }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { email: @sponsor.email, fname: @sponsor.fname, lname: @sponsor.lname, number: @sponsor.number }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
